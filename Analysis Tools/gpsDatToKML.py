...
def createkml(apDict):
   kmlfile = open("data/apdata.kml","w")
   ...
   for bssid in apDict.keys():
      ...
      # assume no security: Red
      apcolor = base_url + "pushpin/red-pushpin.png"
      if "WPA2" in sec:
         # Purple
         apcolor = base_url + "pushpin/grn-pushpin.png"
      elif "WPA" in sec:
         # Green
         apcolor = base_url + "pushpin/grn-pushpin.png"
      elif "WEP" in sec:
         # Yellow
         apcolor = base_url + "pushpin/ylw-pushpin.png"
